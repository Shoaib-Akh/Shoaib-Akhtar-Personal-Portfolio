  ...
  return (
    <Provider {...{ store }}>
      <PersistGate loading={<Preloader />} {...{ persistor }}>
        ...
        >
          <Head>
            <title>Shoaib Akhtar - Personal Portfolio</title>
            <meta name="title" content="Shoaib Akhtar" />
            <meta
              name="description"
            ...
            <meta property="og:title" content="Shoaib Akhtar" />
            <meta
            ...
            />
            <meta property="twitter:title" content="Shoaib Akhtar" />
            <meta
